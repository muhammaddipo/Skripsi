...
\newcommand{\@judultopik}{Pengujian Berbasis \textit{Behavior Specificatino}} % Judul/topik anda
...
Pengujian dengan basis \textit{behaviour specification} akan berfokus kepada hal yang \textit{stakeholder/customer} harapkan pada suatu sistem dengan \textit{behaviour} yang sudah di spesifikasikan. Pengujian akan berawal dengan membuat \textit{Specification} yang berisi [4]:
\begin{enumerate}
...
\end{enumerate}
\textit{Developer} akan menjadikan \textit{specification} sebagai patokan dasar bekerjanya suatu sistem, dan akan melakukan pengujian berbasis \textit{specification}. Pengujian dilakukan untuk memastikan bahwa sistem sudah bekerja sesuai apa yang \textit{stakeholder/customer} harapkan, dan jika \textit{specification} berhasil dilakukan, maka sistem sudah siap untuk digunakan.
